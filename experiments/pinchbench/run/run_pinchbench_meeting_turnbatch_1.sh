...
OUTPUT_DIR="${PINCHBENCH_MEETING_OUTPUT_DIR:-${PINCHBENCH_ROOT}/save/continuous/method/meeting_turnbatch_1}"
...
PINCHBENCH_TMP_ROOT="${PINCHBENCH_TMP_ROOT:-/tmp/pinchbench_meeting_turnbatch_1}"
...
echo "[meeting-turnbatch] batch=1"
...
TOKENPILOT_TASK_STATE_ESTIMATOR_BATCH_TURNS=1 \
