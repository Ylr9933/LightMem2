...
OUTPUT_DIR="${PINCHBENCH_MEETING_OUTPUT_DIR:-${PINCHBENCH_ROOT}/save/continuous/method/meeting_turnbatch_7}"
...
PINCHBENCH_TMP_ROOT="${PINCHBENCH_TMP_ROOT:-/tmp/pinchbench_meeting_turnbatch_7}"
...
echo "[meeting-turnbatch] batch=7"
...
TOKENPILOT_TASK_STATE_ESTIMATOR_BATCH_TURNS=7 \
